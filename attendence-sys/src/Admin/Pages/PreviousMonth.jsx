...
import Table from '../../components/Table/Table6';
...
function DataTable() {
  ...
  const Headers = ["Employee ID", "Employee Name", "Email", "Position", "Salary Month", "Salary"]
    ...
    <section>
      <div className="bg-gray-100 min-h-screen">
        <div className="container mx-auto p-5">
          <h1 className='text-4xl font-medium pb-7'>Previous Salaries</h1>
