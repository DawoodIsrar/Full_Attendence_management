...
export default function MuneebDetails() {
        ...
        <section>
            <div className="bg-gray-100 min-h-screen">
                <div className="container mx-auto p-5 ">
                    <h1 className="text-4xl font-medium pb-7">{name} Details</h1>
                                    ...
                                    <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                        <div className="overflow-x-auto rounded-lg">
                                            <div className="flex justify-between pt-3 mb-5">
                                                <div>
                                                    <Link to={`/Employee/Add_Employee/${name}/${ID}`} className="mx-5 bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">
                                                        Add {name} Detail
                                                    </Link>
                                                    <Link to={`/Employee/Update_Employee/${name}/${ID}`} className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">
                                                        Update Details
                                                    </Link>
                                                </div>
                                                <div>
