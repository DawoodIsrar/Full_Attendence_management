...
import Modal from '../Modal/Model3';
export default function Table(props) {
  ...
  // console.log(Data[1]["Employee Name"])
  return (
    <section >
          ...
          {currentRecords.map((row, index) => (
            <tr key={index} className="border-b hover:bg-gray-50 text-center">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm  text-gray-900 ">
                <Modal index={index} Data={Data} setData={setData} updateLink={updateLink} userName={Data[index]["Employee Name"]} userID={Data[index]["Employee ID"]} Did={currentRecords[index]["Department ID"]} Pid={currentRecords[index].id} />
              </td>
            </tr>
          ))}
        </tbody>
